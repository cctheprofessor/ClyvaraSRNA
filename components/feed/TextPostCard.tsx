...
export default function TextPostCard({ post, currentUserId, onLike, onComment, onDelete, onReport }: TextPostCardProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        <Pressable style={styles.actionButton} onPress={() => onLike(post.id)}>
          ...
          />
          <Text
            style={[styles.actionText, post.user_has_liked && { color: Colors.error }]}
          >
            {post.like_count || 0}
          </Text>
        </Pressable>
