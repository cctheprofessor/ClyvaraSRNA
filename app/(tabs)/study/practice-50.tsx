...
export default function Practice50Screen() {
  ...
  const submitCurrentAnswer = () => {
    ...
    (async () => {
      try {
        ...
        console.warn('[Practice50] API submission failed, using cached validation', error);
  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <PageHeader title="50 Questions" subtitle="Loading practice session" />
  ...
  if (error) {
    return (
      <View style={styles.container}>
        <PageHeader title="50 Questions" subtitle="Practice Mode" />
